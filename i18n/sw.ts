export const sw: Record<string, string> = {
  ...
  reScan: 'Scan Again',
  acquiringGps: 'Inatafuta eneo...',
  gpsAcquiring: 'Inachukua GPS...',
  gpsLocked: 'Eneo limepatikana ✓',
  gpsDenied: 'Ruhusa ya GPS imekataliwa',
  gpsTimedOut: 'GPS imechukua muda mrefu',
  gpsUnavailable: 'GPS haipatikani',
  gpsDeniedFix: 'Nenda Mipangilio > Programu > Bahati > Ruhusa > Washa Eneo',
  gpsTimedOutFix: 'Hamia sehemu ya wazi, bonyeza Jaribu Tena',
  gpsRetry: 'Jaribu Tena',
  gpsSkipProceed: 'Endelea Bila GPS',
  photoReady: 'Photo Ready',
  noPhotoYet: 'No Photo Yet',
  nextFinancialStep: 'Next: Finance Details',
  saving: 'Saving...',
  skipGps: 'GPS inachukua muda? Endelea bila GPS',
  ...
  driverProfileDetails: 'Maelezo ya Wasifu',
  driverProfileDetailsNote: 'Dereva anaweza kujaza namba ya simu na picha ya nyuma hapa, na sehemu hii inaweza kupanuliwa baadaye kwa nyaraka nyingine.',
  currentPhoneLabel: 'Namba ya Simu',
  driverPhoneRequired: 'Tafadhali jaza namba ya simu kwanza',
  driverBackgroundPhoto: 'Picha ya Nyuma',
  driverBackgroundPhotoPlaceholder: 'Hakuna picha ya nyuma bado',
  uploadBackgroundPhoto: 'Pakia Picha ya Nyuma',
  replaceBackgroundPhoto: 'Badilisha Picha ya Nyuma',
  saveDriverProfile: 'Hifadhi Wasifu',
  driverSettingsManagedElsewhere: 'Mipangilio ya Dereva Imehamishwa',
  driverSettingsManagedElsewhereNote: 'Barua pepe ya akaunti, nenosiri, simu na floating coins za dereva hazibadilishwi tena hapa. Tumia ukurasa wa My Status kujaza simu na picha ya nyuma.',
  language: 'Language',
  settings: 'Settings',
  ...
  overdueSettlementAlert: 'Overdue settlement reminder',
  overdueSettlementCountLabel: 'Overdue items',
  overdueSettlementAmountLabel: 'Pending overdue amount',
  ...
  tipLabel: 'Tip',
  settlementExpenseLabel: 'Gharama ya closing',
  settlementExpenseHint: 'Gharama za kampuni sasa zinaandikwa wakati wa daily settlement; mkopo wa ofisi weka kutoka kwenye kadi ya mashine.',
  settlementExpenseCategoryLabel: 'Aina ya gharama',
  settlementExpenseAmountLabel: 'Kiasi cha gharama',
  settlementExpenseNoteLabel: 'Maelezo ya gharama',
  settlementExpenseOptionalLabel: 'Ukikosa gharama, acha wazi',
  settlementExpenseMovedHint: 'Ukurasa wa kazi ya mashine hauandiki tena gharama za kampuni; ziweke kwenye settlement. Mkopo wa ofisi uweke kwenye kadi ya mashine.',
  settlementExpenseRequiredNote: 'Ukichagua Other lazima uandike maelezo.',
  officeLoanLabel: 'Mkopo wa ofisi',
  officeLoanAction: 'Mkopo wa ofisi',
  officeLoanAmountLabel: 'Kiasi cha mkopo',
  officeLoanNoteLabel: 'Maelezo ya mkopo',
  officeLoanSubmit: 'Tuma mkopo',
  officeLoanCreated: 'Mkopo wa ofisi umetumwa, unasubiri idhini.',
  electricityLabel: 'Umeme',
  fuelLabel: 'Fuel',
  repairLabel: 'Repair',
  fineLabel: 'Fine',
  ...
  todayCollectionCount: 'Today Tx',
  todayRevenueTotal: 'Today Rev',
  ...
  auditDebtRecovery: 'Startup Debt Recovery',
  auditDebtEdit: 'Driver Debt Adjustment',
  auditCommissionChange: 'Commission Rate Change',
  auditFloatingCoins: 'Floating Coins Adjustment',
  auditStartupDebtEdit: 'Startup Debt Edit',
  auditBefore: 'Before',
  auditAfter: 'After',
  ...
  fleetSubtitle: 'Drivers, Salaries & Performance',
  cardsViewLabel: 'Cards',
  analyticsViewLabel: 'Analytics',
  addNewDriver: 'Add New Driver',
  searchDriver: 'Search Name / Phone...',
  sortBy: 'Sort By',
  confirmStatusChange: 'Confirm status change?',
  driving: 'Active',
  stopped: 'Inactive',
  driverNameRequired: 'Jaza jina',
  saveFailed: 'Imeshindwa kuhifadhi',
  createDriverFailed: 'Imeshindwa kuunda dereva',
  createDriverSuccess: 'Dereva ameundwa',
  driverOfflineDelete: 'Haiwezi kufuta nje ya mtandao',
  invalidMachineId: 'Weka nambari sahihi ya mashine',
  invalidCoordinates: 'Weka viwianishi sahihi',
  saveLocationFailed: 'Imeshindwa kuhifadhi eneo',
  deleteLocationFailed: 'Imeshindwa kufuta',
  clearBlockersFailed: 'Imeshindwa kusafisha',
  machineRegistered: 'Mashine imesajiliwa',
  payrollActionFailed: 'Imeshindwa operesheni ya mshahara',
  approvalFailed: 'Imeshindwa kuidhinisha',
  settlementSubmitFailed: 'Imeshindwa kuwasilisha malipo',
};
